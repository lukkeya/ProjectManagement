...
class UsuariosDAO {
    ...
    public static function alterarUsuario($tmpUsuario, $tmpEmail){
        ...
        $sqlProj = "Update projetos set emailUsuario_PROJETO = '". $tmpUsuario->getEmail() ."' where emailUsuario_PROJETO like '$tmpEmail'";
        mysqli_query($vConn, $sqlProj) or die(mysqli_error($vConn));
        
        $sqlTarefa = "Update tarefas set emailUsuario_TAREFA = '". $tmpUsuario->getEmail() ."' where emailUsuario_TAREFA like '$tmpEmail'";
        mysqli_query($vConn, $sqlTarefa) or die(mysqli_error($vConn));
        
        $sqlEquipe = "Update equipes set emailUsuario_EQUIPE = '". $tmpUsuario->getEmail() ."' where emailUsuario_EQUIPE like '$tmpEmail'";
        mysqli_query($vConn, $sqlEquipe) or die(mysqli_error($vConn));
